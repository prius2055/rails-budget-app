...
<ul>
    ...
    <li>run git clone "https://github.com/prius2055/rails-budget-app.git"</li>
...
Feel free to check the [issues page](https://github.com/prius2055/rails-budget-app/issues).
